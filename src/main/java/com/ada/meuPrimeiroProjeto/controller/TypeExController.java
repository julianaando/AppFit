...
public class TypeExController {
  ...
  @PutMapping("/{id}")
  public ResponseEntity<TypeExResponse> updateTypeExercise(@PathVariable Integer id, @RequestBody TypeExRequest typeExRequest){
    TypeExResponse typeExResponse = typeExService.updateTypeExercise(id, typeExRequest);
    return ResponseEntity.ok(typeExResponse);
  }
